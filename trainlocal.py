...
# Configuração do MLflow para armazenamento local
...
if __name__ == "__main__":
    ...
    print(f"Treinamento concluído! Dados salvos em: {os.path.abspath('mlruns')}")
    print("Acesse o MLflow UI com: mlflow ui --backend-store-uri file:./mlruns")